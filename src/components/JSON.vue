<!-- JSONLab.vue -->
import authors from "../data/authors.json" import bookstores from "../data/bookstores.json"
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :style="author.name === 'George Orwell' ? { color: '#fff', fontWeight: 'bold', border: '2px solid #42b883' } : {}"
          :title="author.name === 'George Orwell' ? 'This is George Orwell!' : author.name"
        >
          {{ author.name }} ({{ author.birthYear }})
        </li>
      </ul>
...
const searchID = ref(1) // Default value for search ID
